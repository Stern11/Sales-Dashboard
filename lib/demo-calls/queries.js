  ...
  const statements = [
    sql`
      insert into demo_call_leads (
        id, company_name, contact_name, email, phone,
        hubspot_contact_id, hubspot_origin_module, company_scale, source, created_by, updated_by
      ) values (
        ${id}, ${company_name}, ${contact_name}, ${email}, ${phone},
        ${hubspot_contact_id}, ${hubspot_origin_module}, ${blankToNull(company_scale)}, ${blankToNull(source)}, ${actor}, ${actor}
      )
